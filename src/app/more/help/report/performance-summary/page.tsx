...
import { performanceSummaryInfo } from "../components/constant"
...
const PerformanceSummary = () => {
  return (
    <>
      {navigateInfo
        .filter((item) => item.title === "Performance Summary")
        .map((item) => (
      ...
      <div className="mt-[14px]">
        <TextCards>
          <p className="font-medium text-black text-[20px] mb-[5px]">
            {performanceSummaryInfo[0].title}
          </p>
          <p className="text-[16px] text-[#333333] text-normal">
            {performanceSummaryInfo[0].description}
          </p>
          <hr className=" mt-[20px] mb-[20px] border-[1px solid #E6E6E6]" />
          <p className="font-medium text-black text-[20px] mb-[5px]">
            {performanceSummaryInfo[1].title}
          </p>
          <p className="text-[16px] text-[#333333] text-normal">
            {performanceSummaryInfo[1].description}
          </p>
          <hr className=" mt-[20px] mb-[20px] border-[1px solid #E6E6E6]" />
          <p className="font-medium text-black text-[20px] mb-[5px]">
            {performanceSummaryInfo[2].title}
          </p>
          <p className="text-[16px] text-[#333333] text-normal">
            {performanceSummaryInfo[2].description}
          </p>
          <hr className=" mt-[20px] mb-[20px] border-[1px solid #E6E6E6]" />
          <p className="font-medium text-black text-[20px] mb-[5px]">
            {performanceSummaryInfo[3].title}
          </p>
          <p className="text-[16px] text-[#333333] text-normal">
            {performanceSummaryInfo[3].description}
          </p>
          <div className=" mt-[20px]">
            <div className={cn("flex gap-[2px] mb-[2px] items-center w-full")}>
              {performanceSummaryInfo[3].table?.header.map((val, idx) => (
                <div
                  key={`${val}_${idx}`}
                  className={cn(
            ...
            <div className="flex flex-col w-full ">
              {performanceSummaryInfo[3].table?.tableData.map((val, rowIdx) => {
                return (
                  <div
