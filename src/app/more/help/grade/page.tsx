...
import { gradeSystemInfo } from "../constant"

const Grade = () => {
  return (
    <>
      {navigateInfo
        .filter((item) => item.title === "Grade system")
        .map((item) => (
        ...
        <TextCards>
          ...
          <div className=" mt-[20px]">
            ...
            <div className="flex flex-col w-full ">
              {gradeSystemInfo[1].table?.tableData.map((val, rowIdx) => {
                return (
                  <div
