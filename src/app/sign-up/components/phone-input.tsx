    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          ...
          variant={"outline"}
          className={cn(
            "flex  focus-visible:outline-none focus-visible:border-celadon-green focus-visible:bg-azureish-white disabled:bg-light-silver disabled:cursor-not-allowed disabled:text-granite-gray input-shadow border-chinese-silver gap-1 rounded-e-none rounded-s-lg px-3 bg-white"
          )}
          disabled={disabled}
        >
