...
const Header = () => {
	return (
		<div className="h-[350px] bg-stats overflow-hidden bg-fixed bg-[center_top_60px] overflow-y-scroll no-scrollbar bg-no-repeat bg-red-50 text-primary px-5 w-full rounded-b-[32px] pb-5">
